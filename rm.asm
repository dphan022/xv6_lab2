...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1066:	c7 44 24 04 a5 1c 00 	movl   $0x1ca5,0x4(%esp)
    106d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1431:	0f b6 80 18 21 00 00 	movzbl 0x2118(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    158e:	75 09                	jne    1599 <printf+0x101>
          s = "(null)";
    1590:	c7 45 f4 be 1c 00 00 	movl   $0x1cbe,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    165b:	a1 38 21 00 00       	mov    0x2138,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    1726:	a3 38 21 00 00       	mov    %eax,0x2138
}
    172b:	c9                   	leave  
    172c:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    177e:	a1 38 21 00 00       	mov    0x2138,%eax
}
    1783:	c9                   	leave  
    1784:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    179a:	a1 38 21 00 00       	mov    0x2138,%eax
    179f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    17a2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    17a6:	75 23                	jne    17cb <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    17a8:	c7 45 f0 30 21 00 00 	movl   $0x2130,-0x10(%ebp)
    17af:	8b 45 f0             	mov    -0x10(%ebp),%eax
    17b2:	a3 38 21 00 00       	mov    %eax,0x2138
    17b7:	a1 38 21 00 00       	mov    0x2138,%eax
    17bc:	a3 30 21 00 00       	mov    %eax,0x2130
    base.s.size = 0;
    17c1:	c7 05 34 21 00 00 00 	movl   $0x0,0x2134
    17c8:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    181e:	a3 38 21 00 00       	mov    %eax,0x2138
      return (void*)(p + 1);
    ...
    if(p == freep)
    182b:	a1 38 21 00 00       	mov    0x2138,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    190c:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    1913:	00 
    ...
    1951:	c7 44 24 04 d3 1c 00 	movl   $0x1cd3,0x4(%esp)
    1958:	00 
    ...
    197d:	c7 44 24 04 e0 1c 00 	movl   $0x1ce0,0x4(%esp)
    1984:	00 
...
int random(int max){
    ...
    199b:	a1 2c 21 00 00       	mov    0x212c,%eax
    19a0:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    19a6:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    19ab:	a3 2c 21 00 00       	mov    %eax,0x212c
    return (int)(rands % max);
    19b0:	a1 2c 21 00 00       	mov    0x212c,%eax
